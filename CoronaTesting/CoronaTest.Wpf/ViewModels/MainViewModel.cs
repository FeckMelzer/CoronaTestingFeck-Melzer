...
namespace CoronaTest.Wpf.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        private async Task LoadDataAsync()
        {
            ...
            ExaminationsNegativeCount = Examinations.Count(_ => _.TestResult == TestResults.Negative);
            ExaminationsPositiveCount = Examinations.Count(_ => _.TestResult == TestResults.Positive);
        }
    }
}
