...
namespace CoronaTest.Wpf.ViewModels
{
    public class TestParticipantViewModel : BaseViewModel
    {
        ...
        private List<TestResults> _testResults;
        ...
        public TestResults SelectedTestResult
        {
        ...
        public TestParticipantViewModel(IWindowController controller) : base(controller)
        {
            ...
            {
                Core.Sets.TestResults.Unknown,
                Core.Sets.TestResults.Negative,
                Core.Sets.TestResults.Positive
            };
        ...
        private void LoadCommands()
        {
            ...
            CmdTestResult = new RelayCommand(async _ => await TakeOverTestResultAsync(), 
                _ => _examinationStep == ExaminationStep.TakeOverTestResult && SelectedTestResult != Core.Sets.TestResults.Unknown);
        ...
        private void StartNewExamination()
        {
            ...
            SelectedTestResult = Core.Sets.TestResults.Unknown;
        ...
        private async Task CheckExaminationIdentifierAsync()
        {
            ...
            if (Examination != null)
            {
                ...
                _smsService.SendSms(Examination.Participant.Mobilphone, $"CoronaTest - Identcode: {_participantSmsIdentifier} !");
        ...
        {
            if (SelectedTestResult == Core.Sets.TestResults.Negative || SelectedTestResult == Core.Sets.TestResults.Positive)
            {
                await using IUnitOfWork unitOfWork = new UnitOfWork();
                ...
                _smsService.SendSms(Examination
                    .Participant.Mobilphone, 
                    $"CoronaTest - Ergebnis: {examinationInDb.TestResult} !");
