...
namespace CoronaTest.Web.Pages.User
{
    public class ReservationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(Guid? verificationIdentifier, int? id)
        {
            ...
            AuthToken verificationToken = await _unitOfWork.AuthTokens.GetTokenByIdentifierAsync(verificationIdentifier.Value);
        ...
        public async Task<IActionResult> OnPostSaveAsync()
        {
            ...
            var participant = (await _unitOfWork.AuthTokens.GetTokenByIdentifierAsync(VerificationIdentifier)).Participant;
            ...
            else
            {
                examination = new Examination
                {
                    ...
                    TestResult = Core.Sets.TestResults.Unknown,
                    ExaminationState = Core.Sets.ExaminationStates.New,
            ...
            _smsService.SendSms(examination.Participant.Mobilphone, examination.GetReservationText());
