...
namespace CoronaTest.Web.Pages
{
    public class RegistrationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            AuthToken verificationToken = AuthToken.NewToken(participant);

            await _unitOfWork.AuthTokens.AddAsync(verificationToken);
            await _unitOfWork.SaveChangesAsync();

            _smsService.SendSms(participant.Mobilphone, $"CoronaTest - Token: {verificationToken.Token} !");
