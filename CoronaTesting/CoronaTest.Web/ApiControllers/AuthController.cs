...
namespace CoronaTest.Web.ApiControllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
          new User { Email = "admin@htl.at", Password=AuthUtils.GenerateHashedPassword("admin"), Role = "Admin" },
          new User { Email = "user@htl.at", Password=AuthUtils.GenerateHashedPassword("user"), Role = "User" }
        };
