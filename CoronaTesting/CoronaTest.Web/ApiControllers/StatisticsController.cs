    ...
    public class StatisticsController : ControllerBase
    {
        ...
        public async Task<ActionResult<StatisticsDto>> GetStatisticsInPeriode(DateTime from, DateTime to)
        {
            ...
            if (examinations != null)
            {
                ...
                statistic.CountOfUnknownResult = examinations.Count(_ => _.TestResult == Core.Sets.TestResults.Unknown);
                statistic.CountOfPositiveResult = examinations.Count(_ => _.TestResult == Core.Sets.TestResults.Positive);
                statistic.CountOfNegativeResult = examinations.Count(_ => _.TestResult == Core.Sets.TestResults.Negative);
            }
        ...
        public async Task<ActionResult<StatisticsWithWeekDto[]>> GetStatisticsWithWeekNumberInPeriode(DateTime from, DateTime to)
        {
            ...
            statistic = examinations.GroupBy(_ => $"{_.ExaminationAt.Year}_{calendar.GetWeekOfYear(_.ExaminationAt, CalendarWeekRule.FirstFourDayWeek, DayOfWeek.Monday):d2}")
                .Select(_ => new StatisticsWithWeekDto {
                    ...
                    CountOfUnknownResult = _.Count(_ => _.TestResult == Core.Sets.TestResults.Unknown),
                    CountOfPositiveResult = _.Count(_ => _.TestResult == Core.Sets.TestResults.Positive),
                    CountOfNegativeResult = _.Count(_ => _.TestResult == Core.Sets.TestResults.Negative)
                })
                .OrderBy(_ => _.Year)
