...
namespace CoronaTest.Persistence.Migrations
{
    ...
    [Migration("20210420095022_inital")]
            ...
            modelBuilder.Entity("CoronaTest.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Email = "admin@htl.at",
                            Password = "DEA8Q1fsW+rtSAGuMaovxNlcVZNQkUzK2uh/iCvljYc=5c9a6226b37deeccef54a701091b40ec",
                            UserRole = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            Email = "user@htl.at",
                            Password = "mvrsO9jUpgdNkHYeaSxcGs2MOxUWJU/vO6vE2n+VojU=4dd666990578e385d2d36da85abfaec0",
                            UserRole = "User"
                        });
                });
